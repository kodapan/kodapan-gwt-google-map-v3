...
package se.kodapan.gwt.google.maps.v3.client.auto;

import com.google.gwt.core.client.JavaScriptObject;
import se.kodapan.gwt.google.maps.v3.client.LatLng;
import se.kodapan.gwt.google.maps.v3.client.LatLngBounds;
...
public class GeocoderRequest extends JavaScriptObject {
   ...
   * Address. Optional.
   *
   * @return TODO: Missing comments for return value.
   */
   ...
   * Address. Optional.
   *
   * @param address TODO: Missing comments for parameter address.
   */
   ...
   * LatLngBounds within which to search. Optional.
   *
   * @param bounds TODO: Missing comments for parameter bounds.
   */
   ...
   * Preferred language for results. Optional.
   *
   * @param language TODO: Missing comments for parameter language.
   */
   ...
   * LatLng about which to search. Optional.
   *
   * @param latLng TODO: Missing comments for parameter latLng.
   */
   ...
   * Country code top-level domain within which to search. Optional.
   *
   * @param region TODO: Missing comments for parameter region.
   */
